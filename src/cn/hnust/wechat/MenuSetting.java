...
public class MenuSetting {
	...
	public static String appId = "wxdeec7000639b4f95";
    public static String appSecret= "86f2543c399fe27517618fd97ee805c3";
    ...
    public static void add() throws JSONException{
        ...
        String json = "{"
                ...
                + "\"type\":\"view\","
                + "\"name\":\"开始答题\","
                + "\"url\":\"http://iugjxh。natappfree.cc/wechat/qa.html\""
                + "}]"
        		+ "},"
        		+ "{"
        		+ "\"name\":\"我的排名\","
